        ...
        >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-4 gap-5">
                <div className="stat bg-sky-900 rounded-lg">
                    ...
                    <div className="stat-value text-secondary my-2">17+</div>
                ...
                <div className="stat bg-sky-900 rounded-lg ">
                    ...
                    <div className="stat-value text-secondary my-2">250K+</div>
                ...
                <div className="stat bg-sky-900 rounded-lg">
                    ...
                    <div className="stat-value text-secondary my-2">434+</div>
                ...
                <div className="stat bg-sky-900 rounded-lg">
                    ...
                    <div className="stat-value  text-secondary my-2">268+</div>
